...
export const Details: React.FC<DetailsProps> = ({ work, closeDetails, isDetails }) => {
  ...
  return (
    <React.Fragment>
      <CSSTransition in={isDetails} mountOnEnter timeout={300} classNames="details-transition" unmountOnExit>
